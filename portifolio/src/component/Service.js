    ...
    <div>
     ...
     <div className='flex flex-col items-center'>
        <img className='text-teal-400 w-12' src='image/coding.png'></img>
           <p className='text-gray-400 my-4 text-sm '>Web Development</p> 
        </div>
        <div className='flex flex-col items-center'>
        <img className='text-teal-400 w-12' src='image/illustration.png'></img>
           <p className='text-gray-400 my-4 text-sm'>UI/UX Design</p> 
        </div>
        <div className='flex flex-col items-center'>
        <img className='text-teal-400 w-12' src='image/image.png'></img>
           <p className='text-gray-400 my-4 text-sm'>Graphic Design</p> 
        </div>
     </div>
    </div>
  )
